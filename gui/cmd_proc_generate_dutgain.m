...
% site_calval           = "site_calval_TAR3115_dataset_Data3mV"
    ...
    sqlquery = sprintf("create table %s as select distinct d.file_name, d.file_date_unixepoch, d.data_type, d.frequency_MHz, d.angle," + ...
    ...
    % Issue resolved: double record. https://www.ipentec.com/document/sql-duplicate-records-with-join

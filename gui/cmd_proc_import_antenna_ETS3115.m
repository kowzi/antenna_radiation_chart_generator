function cmd_proc_import_antenna_ETS3115(filename_db, input_antenna_dir, frequency_step_MHz, flag_filegeneration)
...
%input_antenna_dir  = "../input_cal/Datasheet_HornAnttena_ETS3115/"
    ...
    % =======================================================================
    % (1) Reading .xlsx file of the antenna datasheet
    ...
    % + New frequency points for the interpolation
    Data_1mV_Interp_Freq  = Data_1mV.Frequency_MHz_(1):frequency_step_MHz:Data_1mV.Frequency_MHz_(end);
    Data_1mH_Interp_Freq  = Data_1mH.Frequency_MHz_(1):frequency_step_MHz:Data_1mH.Frequency_MHz_(end);
    Data_3mV_Interp_Freq  = Data_3mV.Frequency_MHz_(1):frequency_step_MHz:Data_3mV.Frequency_MHz_(end);
    Data_3mH_Interp_Freq  = Data_3mH.Frequency_MHz_(1):frequency_step_MHz:Data_3mH.Frequency_MHz_(end);
    
    
    % + An interpolatoin process
    ...
    % =======================================================================
    % Generating characteristic image.
    % =======================================================================

    if( flag_filegeneration == true )
        hold on;

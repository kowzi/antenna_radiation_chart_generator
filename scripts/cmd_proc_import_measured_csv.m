function cmd_proc_import_measured_csv(filename_db, csv_filepath_name, db_table)
    ...
    sqlquery = "CREATE TABLE IF NOT EXISTS "+db_table+ ...
        "(id INTEGER PRIMARY KEY AUTOINCREMENT, file_name TEXT, file_date_unixepoch REAL, frequency_MHz REAL, angle REAL, meas_s21_dB REAL)";
    ...
    for m=2:1:length(csv_cells(2,:))        % maximum = the number of frequencies.
        ...
        data = table(buff_csv_filename_ext,buff_csv_posixtime,buff_csv_cells_freq_MHz,csv_angle,csv_s21dB,'VariableNames',{'file_name' 'file_date_unixepoch' 'frequency_MHz' 'angle' 'meas_s21_dB'});

function cmd_genfig_s11_vswr(inout_dir, filenames, cmdXlim, format_style, saveformat, cmdLegendTexts, cmdColorOrder, cmdLineStyleOrder, cmdLineWidthOrder, cmdShowLimitLine)
...
%   alt_filenames   ... alternate filename used for the legend. ex. = ["Proposed 1"; "Proposed 2";];
    ...
    if(contains(format_style,"ieee"))
        ...
        ylabel('|S_{11}| (VSWR)'  ,'FontWeight','bold','FontName',text_font);

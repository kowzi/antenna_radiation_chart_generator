function cmd_genfig_s11_phase(output_dir, filenames, cmdXlim, format_style, saveformat, cmdLegendTexts, cmdColorOrder, cmdLineStyleOrder, cmdLineWidthOrder, cmdUnwrap)
...
%   alt_filenames   ... alternate filename used for the legend. ex. = ["Proposed 1"; "Proposed 2";];
    ...
    ylabel('|S_{11}| (deg)'  ,'FontWeight','bold','FontName','Times New Roman')
